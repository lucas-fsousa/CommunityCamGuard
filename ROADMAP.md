...
| P1 | Smart Protection — typed master on/off is implemented through its proven scalar leaf with preflight/readback and without overwriting adjacent guard settings. Camera-3 dashboard validation and the separately typed weekly schedule UI remain | wip |
