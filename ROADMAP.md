...
| P1 | Native video receive path: bounded KCP/MTP/V1 replay and independent HEVC/AAC decoding validated offline. Configured-IDR restart gate now passed three 120-frame fresh-decoder recovery scenarios; ungated negative control failed (74/120). Raw timestamps are not UTC. No live production switch. Next: native receive lifecycle/KCP state handoff, reconnect/pacing/A-V sync and bounded single-producer handoff. See `docs/internal/native-video-recovery.md` and `native-media-receive.md` | wip |
