...
| P1 | Native video receive path: bounded KCP/MTP replay, cookie correlation and incremental V1 records implemented. Independent strict FFmpeg decoding passed 1,137 HEVC 640×360 frames and 1,172 AAC mono/16 kHz frames, matching parser counts/header; 1080p prefix passed three frames before the known KCP gap. No live production switch. Raw timestamps are not UTC. Next: keyframe/config transitions, reconnect/pacing and bounded single-producer handoff. See `docs/internal/native-media-receive.md` | wip |
