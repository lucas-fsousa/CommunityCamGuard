...
| P1 | Native video receive path: bounded KCP/MTP replay plus exact endpoint/link/call-ID cookie correlation implemented. Historical complete-message decoding recovered 640×360 and 1920×1080 V1 headers (15 fps, mono 16 kHz); unmatched sessions stay undecoded and a missing-sequence flow still terminates safely. No nonzero KCP fragments observed. Isolated from working intercom/RTSP. Next: StreamPipe/frame boundaries, codec/keyframe/timestamps and single-producer handoff. See `docs/internal/native-media-receive.md` | wip |
