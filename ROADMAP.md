...
| P1 | Native video receive path: bounded KCP message assembly/pinned-peer adapter and streaming PCAP replay implemented. Existing capture: 7,222 valid MTP datagrams, nine clean conversations and one terminal missing-sequence gap; no nonzero KCP fragments observed. Still isolated from working intercom/RTSP. Next: cookie-correlated complete-message decryption, StreamPipe/frame boundaries, codec/keyframe/timestamps and single-producer handoff. See `docs/internal/native-media-receive.md` | wip |
