...
| P1 | Production P2P bootstrap, direct route proof and allowlisted thing-model reads — encrypted enrollment, list/certification, inventory, heartbeat, A4/A3, CA/CB and B7; no media/write/action yet | done |
