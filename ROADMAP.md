...
| P1 | Native PTZ RELEASE-only check on camera 3 passed strict delivery correlation after exact-unit preparation, without START. Full B9 application replies now receive BA peer receipts with separate sequence allocation. Physical short-gesture/STOP validation and browser lease integration remain pending | wip |
