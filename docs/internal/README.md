...
| [Runtime settings](runtime-settings.md) | Two-field persistence/API, revision conflicts, primary-only writes and next-operation semantics; deployment/UI pending |
