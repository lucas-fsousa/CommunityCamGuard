...
- **[Provisioning error audit](internal/provisioning-public-errors.md)** — Wi-Fi/QR and handled BLE/session errors sanitized; label/privileged errors still pending.
