...
- **[Login requests/cookies](internal/login-request-boundaries.md)** — byte/deadline/work limits, redacted validation errors and remaining proxy/origin review.
...
- **[Provisioning error audit](internal/provisioning-public-errors.md)** — fixed Wi-Fi/QR, BLE, identification and handled privileged errors; payload/log review pending.
